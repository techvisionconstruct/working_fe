...
declare global {
  interface Window {
    createTemplateTourEndCallback?: () => void;
  }
}
...
export function CreateTemplateTour({ isRunning, setIsRunning, activeTab, setActiveTab }: CreateTemplateTourProps) {
  ...
  useEffect(() => {
    if (isRunning) {
        ...
        steps: [
          {
            popover: {
              ...
              description: `<p>Welcome to the Template Creator!</p><p>Let's walk through the process of creating a professional template.</p>`,
              align: "center",
              onNextClick: () => {
                moveToTab("details");
                driverObj.moveNext();
          ...
          },
          {
            ...
            popover: {
              ...
              description: `<p>Start by adding basic information about your template.</p><p>Give it a name, description, and add a cover image if needed.</p>`,
              side: "bottom",
              align: "start",
              onNextClick: () => {
                moveToTab("modules");
      ...
      window.createTemplateTourEndCallback = endTour;
      driverObj.drive();
      return () => {
        driverObj.destroy();
        delete window.createTemplateTourEndCallback;
      };
    }
