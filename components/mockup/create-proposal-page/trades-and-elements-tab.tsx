        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Fill in the essential information to define your trades and elements.
            </p>
          </div>
        </div>
        <Separator />
          ...
          <div>
            <div className="pb-3">
              <div className="text-lg flex items-center justify-between">
                ...
                {/* Global Markup Switch and Input */}
                                  ...
                                  >
                                    <div className="flex items-center gap-3 p-4 rounded border bg-background relative group">
                                      <div className="flex-1 min-w-0">
                                        ...
                                        {/* Modern Material and Labor Cost Display (no background) */}
                                        <div className="mt-2 pt-2 border-t border-dashed space-y-1">
                                          {element.material_cost_formula && (
                                            <div className="flex items-center gap-2">
                                              ...
                                              <code className="text-xs px-1 py-0.5 rounded border border-muted/30">
                                                {replaceVariableIdsWithNames(
                                                  element.material_cost_formula,
                                                  variables,
                                                  element.material_formula_variables || []
                                              ...
                                              <span className="text-xs font-bold text-green-600 ml-2">
                                                {(() => {
                                                  try {
                                                    const value = calculateFormulaValue(element.material_cost_formula, variables);
                                          ...
                                          {element.labor_cost_formula && (
                                            <div className="flex items-center gap-2 mt-1">
                                              ...
                                              <span className="text-xs font-bold text-blue-600 ml-2">
                                                {(() => {
                                                  try {
                                                    const value = calculateFormulaValue(element.labor_cost_formula, variables);
                                                    return value !== null ? value : "-";
                                                  } catch {
                                                    return "-";
                                                  }
                                        ...
                                        <div className="flex items-center gap-2 mt-2">
                                          ...
                                          <span className="text-xs font-bold text-orange-600">
                                            {element.markup != null ? `${element.markup}%` : "-"}
                                          </span>
                                          {isGlobalMarkupEnabled && element.markup === globalMarkupValue && (
                                            <span className="rounded-full bg-primary/20 px-2 py-0.5 text-xs ml-2">Global</span>
                                          )}
                                        </div>
                                      </div>
                                      <div className="absolute -top-2 -right-2 flex gap-1">
