...
import { Play, ArrowRight, CheckCircle, ChevronLeft, ChevronRight, Star, ArrowUpRight, ExternalLink, Ruler, HardHat } from "lucide-react"
...
export default function LandingPage() {
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    if (industriesRef.current) {
      const { left, top, width, height } = industriesRef.current.getBoundingClientRect();
  ...
  const industries: Industry[] = [
    {
      ...
      image: "https://www.austintec.com/wp-content/uploads/2024/05/what-do-electrical-engineers-do.jpg",
      description: "Detailed electrical diagrams, code compliance checklists, and material specifications.",
    },
    {
      title: "Plumbing Professionals",
      image: "https://www.icominc.com/wp-content/uploads/2021/08/TA9Q9bV3Z81nZRooviZz51Y4bpnXIdBt1623180634.jpg",
      description: "Pipe layouts, fixture specifications, and water system diagrams with cost breakdowns.",
    },
    {
      title: "ADU Builders",
      image: "https://www.chase.com/content/dam/unified-assets/photography/articles/primary/mortgage/seo_accessory-dwelling-unit-adu_12152023.jpg",
      description: "Complete ADU project proposals with floor plans, permits, and timeline projections.",
    },
  ];
  ...
  const SectionHeader = ({ badge, title, description }: { badge: string, title: string, description: string }) => (
    ...
    >
      <div className={`${oswald.className} inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm font-medium mb-4`} 
        style={{ 
      ...
      >
        <span className="h-1.5 w-1.5 rounded-full" style={{ backgroundColor: "hsl(0, 85%, 30%)" }}></span>
        {badge}
        <span className="h-1.5 w-1.5 rounded-full" style={{ backgroundColor: "hsl(0, 85%, 30%)" }}></span>
      </div>
      <h2 className={`${oswald.className} text-4xl md:text-5xl font-bold tracking-tight mb-6 uppercase`} 
         style={{ color: "hsl(20, 10%, 15%)" }}
      >
        {title}
      </h2>
      <div className="flex justify-center items-center mb-6">
        <div className="h-0.5 w-16" style={{ backgroundColor: "hsl(40, 100%, 50%)" }}></div>
        <div className="h-3 w-3 mx-2 transform rotate-45" style={{ backgroundColor: "hsl(40, 100%, 50%)" }}></div>
        <div className="h-0.5 w-16" style={{ backgroundColor: "hsl(40, 100%, 50%)" }}></div>
      </div>
  ...
  return (
    <div className={`flex min-h-screen flex-col ${inter.className}`} 
      style={{ backgroundColor: "hsl(0, 0%, 100%)", color: "hsl(20, 10%, 15%)" }}
    >
      <Navbar />
      ...
      <main className="flex-1">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            >
              <motion.div 
                ...
                className="absolute top-1/4 left-0 w-full h-[2px] bg-white/10 -rotate-[30deg] transform origin-left"></motion.div>
              <motion.div 
                initial={{ x: -100, opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 1.8, delay: 0.4 }}
                className="absolute top-1/3 left-0 w-full h-[1px] bg-white/10 rotate-[20deg] transform origin-left"></motion.div>
              <motion.div 
                initial={{ x: -100, opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 1.8, delay: 0.6 }}
                className="absolute top-2/3 left-0 w-full h-[3px] bg-white/5 -rotate-[10deg] transform origin-left"></motion.div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute top-20 right-20 w-40 h-40 border-8 border-white/10"></motion.div>
            <motion.div 
              initial={{ opacity: 0, rotate: 0 }}
              animate={{ opacity: 1, rotate: 12 }}
              transition={{ duration: 1.5, delay: 1 }}
              className="absolute bottom-40 left-20 w-20 h-20 border-4 border-white/10"></motion.div>
            <motion.div 
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 1.5, delay: 1.2 }}
              className="absolute top-1/2 left-1/2 w-60 h-60 border-2 border-dashed border-white/10 rounded-full"></motion.div>
          ...
          <div className="container relative z-10 h-full flex items-center justify-center mx-auto">
            <div className="grid gap-16 md:grid-cols-2 items-center py-16 text-center md:text-left">
              ...
              >
                ...
                >
                  Build Better
                  <span className="block" style={{ color: "hsl(40, 100%, 50%)" }}>
                    Proposals.
                  </span>
                ...
                >
                  The professional proposal builder designed specifically for construction industry professionals.
                </motion.p>
                <motion.div 
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <Button size="lg" className="rounded-full bg-white hover:bg-white/90 text-lg px-8 h-12" style={{ color: "hsl(0, 85%, 30%)" }}>
              ...
              <div className="relative">
                ...
                >
                  ...
                  >
                    <Image 
                      src="https://i.ibb.co/Xx7sRDVK/img.webp" 
                  ...
                  >
                    <Image 
                      src="https://i.ibb.co/gbWNDnBL/com-08.jpg" 
                      alt="Modern kitchen" 
                      fill 
                      className="object-cover"
                    />
                  ...
                  >
                    <Image 
                      src="https://i.ibb.co/svv6xXBV/avoidcost.jpg" 
                      alt="Modern bathroom" 
                      fill 
                      className="object-cover" 
                    />
                  ...
                  >
                    <Image 
                      src="https://i.ibb.co/Z1dmHDSp/headpic.jpg" 
                      alt="Modern bedroom" 
                      fill 
                      className="object-cover" 
                    />
                  ...
                  >
                    <Image 
                      src="https://i.ibb.co/ynDY5rQF/img3.webp" 
                  ...
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-40">
                    ...
                    >
                      ...
                      <motion.div 
                        ...
                        whileHover={{ boxShadow: "0 0 15px 5px rgba(255, 255, 255, 0.3)" }}
                      >
                        <Play className="h-10 w-10 text-primary" style={{ color: "hsl(0, 85%, 30%)" }} />
                      </motion.div>
        ...
        <section id="features" className="py-32" style={{ background: "linear-gradient(to bottom, hsl(0, 0%, 100%), hsl(20, 10%, 96%))" }}>
                ...
                [
                  {
                    ...
                    description: "Pre-built templates designed for electrical, plumbing, ADU construction and more.",
                  },
                  {
                    icon: (
                      <svg
                    ...
                    description: "Accurate cost calculations with built-in material and labor databases.",
                  },
                  {
                    icon: (
                      <svg
                    ...
                    description: "Include 3D renderings and visual mockups to help clients see the finished project.",
                  },
                  {
                    icon: (
                      <svg
                    ...
                    description: "Mix and match proposal sections to create the perfect document for each client.",
                  },
                  {
                    icon: (
                      <svg
                    ...
                    description: "Keep track of all your clients and their project requirements in one place.",
                  },
                  {
                    icon: (
                      <svg
                    ...
                    description: "Secure e-signature capabilities for faster project approvals and contract signing.",
                  },
                ] as const
              ).map((feature, index) => (
                <motion.div
        ...
        <section id="industries" className="py-32 relative overflow-hidden" style={{ backgroundColor: "hsl(20, 10%, 96%)" }}>
          ...
          <div className="container px-4 mx-auto relative z-10 max-w-7xl">
            ...
            >
              ...
              >
                <h3 className={`${oswald.className} text-3xl font-bold uppercase`} style={{ color: "hsl(20, 10%, 15%)" }}>
                  Industry Solutions
                </h3>
                <div className="flex items-center gap-6">
                  ...
                  >
                    {industries.map((_, idx) => (
                      <button
                        ...
                        style={{ width: idx === currentIndustry ? '2.5rem' : '0.5rem', height: '0.5rem', transition: 'all 0.3s ease' }}
                      >
                        <motion.div 
                          className="absolute inset-0 rounded-md"
                          style={{ 
                            backgroundColor: idx === currentIndustry ? "hsl(0, 85%, 30%)" : "hsla(0, 85%, 30%, 0.3)",
                          }}
                        ...
                        {idx === currentIndustry && (
                          <motion.div 
                            ...
                            initial={{ scaleX: 0 }}
                            animate={{ scaleX: 1 }}
                            transition={{ duration: 5, ease: "linear", repeat: 1, repeatDelay: 0 }}
                            style={{ backgroundColor: "hsla(40, 100%, 50%, 0.5)" }}
                          />
                        )}
                      </button>
                    ))}
                  ...
                  <div className="flex space-x-4">
                    <motion.button
                      ...
                      className={`w-12 h-12 rounded-full flex items-center justify-center shadow-lg ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                      style={{
                ...
                {isLoading ? (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <motion.div 
                      ...
                      style={{ borderColor: "hsla(0, 85%, 30%, 0.3)", borderTopColor: "transparent" }}
                    />
                  </div>
                ) : (
                  <>
                    ...
                    <div className="absolute inset-0 transition-opacity duration-300"
                         style={{
                           ...
                           transform: `rotateY(${(mousePosition.x - 0.5) * 5}deg) rotateX(${(0.5 - mousePosition.y) * 5}deg)`
                         }}
                    >
                      {industries.map((industry, index) => (
                        <div
                          ...
                          className={`absolute inset-0 transition-opacity duration-500 ease-in-out ${
                            index === activeVisibleIndustry ? "opacity-100 z-20" : "opacity-0 z-10"
                          }`}
                        >
                          ...
                          <div 
                            ...
                            style={{
                              background: "linear-gradient(to right, hsla(20, 10%, 15%, 0.9), hsla(20, 10%, 15%, 0.7) 60%, transparent)"
                            }}
                          >
                            <div className="max-w-2xl">
                              <div 
                                className={`inline-block mb-6 px-4 py-1.5 text-sm font-medium rounded-full backdrop-blur-md ${oswald.className}`}
                                style={{ backgroundColor: "hsla(40, 100%, 50%, 0.2)", color: "hsl(40, 100%, 50%)" }}
                              >
                                {industry.title}
                              </div>
                              ...
                              <div className="flex flex-wrap gap-5">
                                ...
                                >
                                  ...
                                  <span className="relative z-10 flex items-center">
                                    Case Studies <ExternalLink className="ml-2 h-4 w-4" />
                                  </span>
                                </Button>
                              </div>
                            </div>
                            ...
                            >
                              <div 
                                ...
                                style={{ backgroundColor: "hsl(40, 100%, 50%)" }}
                              />
                              <span style={{ color: "hsl(0, 0%, 100%)" }}>Industry-specific templates included</span>
                            </div>
                          </div>
                          ...
                          >
                            ...
                            >
                              <span className="font-medium mr-2" style={{ color: "hsl(20, 10%, 15%)" }}>Scroll to explore</span>
                              <div 
                                className="h-8 w-8 rounded-full flex items-center justify-center"
                                style={{ backgroundColor: "hsl(0, 85%, 30%)" }}
                              >
                                <div className="animate-pulse-down">
                                  <ChevronRight className="h-5 w-5 rotate-90" style={{ color: "hsl(0, 0%, 100%)" }} />
                                </div>
                              </div>
                            </div>
                          </div>
              ...
              >
                {industries.map((industry, idx) => (
                  <motion.div 
                    ...
                    onClick={() => !isLoading && allImagesLoaded && setCurrentIndustry(idx)}
                    ...
                    style={{ 
                      width: '120px', 
                      height: '80px',
                      border: idx === currentIndustry ? '3px solid hsl(0, 85%, 30%)' : '3px solid transparent',
                  ...
                  >
                    ...
                    <div 
                      ...
                      style={{ 
                        backgroundColor: hoveredIndustry === idx || idx === currentIndustry
                          ? "hsla(0, 85%, 30%, 0.7)"
                          : "hsla(20, 10%, 15%, 0.7)" 
                      }}
                    >
                      <p className={`${oswald.className} text-xs font-medium text-center px-2 uppercase`} style={{ color: "hsl(0, 0%, 100%)" }}>
                        {industry.title}
                      </p>
                    </div>
                  </motion.div>
        ...
        {/* MODERNIZED: Testimonial section with construction typography */}
        <section id="testimonials" className="py-32" style={{ backgroundColor: "hsl(0, 0%, 100%)" }}>
          <div className="container px-4 mx-auto max-w-7xl">
            <SectionHeader 
              badge="Testimonials" 
              title="Success Stories" 
              description="Join thousands of happy construction professionals who have transformed their proposal process"
            />

            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              {/* Featured testimonial with updated styling */}
              <motion.div 
                className="col-span-1 lg:col-span-6 rounded-2xl overflow-hidden shadow-lg relative"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                style={{ 
                  backgroundColor: "hsl(20, 10%, 96%)",
                  borderLeft: "4px solid hsl(0, 85%, 30%)"
                }}
              >
                <div className="p-8 md:p-10 h-full flex flex-col">
                  ...
                  <blockquote className="text-2xl font-medium text-gray-900 mb-6 flex-grow">
                    "Simple ProjeX has completely transformed our business. Our proposals now look professional and our clients are impressed with the level of detail. Our win rate has increased by 40% in just the first three months."
                  </blockquote>
                  ...
                  <footer className="mt-auto">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Rodriguez Electrical Services</p>
                      </div>
                    </div>
                  </footer>
                  ...
                  <div className="absolute top-8 right-8">
                    <svg width="40" height="32" viewBox="0 0 40 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M11.5 0C5.14907 0 0 5.14907 0 11.5C0 17.8509 5.14907 23 11.5 23C17.8509 23 23 17.8509 23 11.5C23 5.14907 17.8509 0 11.5 0ZM28.5 0C22.1491 0 17 5.14907 17 11.5C17 17.8509 22.1491 23 28.5 23C34.8509 23 40 17.8509 40 11.5C40 5.14907 34.8509 0 28.5 0Z" fill="#f0f0f0"/>
                    </svg>
                  </div>
                </div>
              </motion.div>
              
              {/* Smaller testimonials with updated styling */}
              <div className="col-span-1 lg:col-span-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                {(
                  [
                    {
                      quote: "The industry-specific templates are a game-changer. Our proposals look more professional and include all the details our clients need to make decisions.",
                      author: "Sarah Johnson",
                      company: "Modern Plumbing Solutions",
                      image: "https://randomuser.me/api/portraits/women/44.jpg"
                    },
                    {
                      quote: "As an ADU specialist, I need to show clients exactly what they're getting. Simple ProjeX's visualization tools help me close deals faster than ever.",
                      author: "David Chen",
                      company: "Chen ADU Builders",
                      image: "https://randomuser.me/api/portraits/men/86.jpg"
                    },
                    {
                      quote: "The time savings alone are worth the investment. What used to take days now takes hours, and I can send more proposals to win more business.",
                      author: "Anna Martinez",
                      company: "AM Construction",
                      image: "https://randomuser.me/api/portraits/women/23.jpg"
                    },
                    {
                      quote: "The customer support team is amazing. They helped us customize templates for our specific needs and were always available to answer questions.",
                      author: "James Wilson",
                      company: "Wilson & Sons Builders",
        ...
        <section id="pricing" className="py-32 relative overflow-hidden" style={{ backgroundColor: "hsl(20, 10%, 96%)" }}>
          {/* Background patterns */}
          <div className="absolute inset-0 z-0">
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
                  <path d="M 40 0 L 0 0 0 40" fill="none" stroke="hsla(20, 10%, 90%, 0.7)" strokeWidth="1" />
                </pattern>
              </defs>
          ...
          <div className="container px-4 mx-auto relative z-10 max-w-7xl">
            <motion.div 
              ...
              transition={{ duration: 0.8, ease: "easeOut" }}
            >
              <div className="inline-block rounded-full px-4 py-1.5 text-sm font-medium mb-4" style={{ 
                backgroundColor: "hsla(0, 85%, 30%, 0.1)",
                color: "hsl(0, 85%, 30%)" 
              }}>
                Pricing
              </div>
              <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6" style={{ color: "hsl(20, 10%, 15%)" }}>
                      ...
                      <ul className="space-y-3">
                        {plan.features.map((feature, i) => (
                          <li key={i} className="flex items-start gap-3">
                            <CheckCircle className={`h-5 w-5 mt-0.5 ${plan.highlighted ? "text-primary" : "text-gray-500"}`} />
            ...
            >
              <h3 className="text-xl font-bold mb-4">Have questions about our pricing?</h3>
      ...
      <footer className="pt-20 pb-10" style={{ backgroundColor: "hsl(20, 10%, 15%)", color: "hsl(0, 0%, 100%)" }}>
        <div className="container px-4 mx-auto">
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5 mb-16">
            <div className="col-span-1 lg:col-span-2">
              ...
              <p className="mb-8 max-w-md" style={{ color: "hsl(20, 10%, 70%)" }}>
                Professional proposal software designed specifically for construction industry professionals to win more projects.
              </p>
              <div className="flex gap-4">
                <Link href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-primary/20 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <Link href="#features" className="hover:text-white transition-colors" style={{ color: "hsl(20, 10%, 70%)" }}>
                    Features
                  </Link>
                </li>
                <li>
                  <Link href="#industries" className="hover:text-white transition-colors" style={{ color: "hsl(20, 10%, 70%)" }}>
                    Industries
                  </Link>
                </li>
                <li>
                  <Link href="#pricing" className="hover:text-white transition-colors" style={{ color: "hsl(20, 10%, 70%)" }}>
                    Pricing
                  </Link>
                </li>
                <li>
                  <Link href="#" className="hover:text-white transition-colors" style={{ color: "hsl(20, 10%, 70%)" }}>
                    Templates
                  </Link>
                </li>
              </ul>
          ...
          <div className="pt-8 flex flex-col sm:flex-row justify-between items-center" style={{ borderTopColor: "hsl(20, 10%, 25%)", borderTopWidth: "1px" }}>
