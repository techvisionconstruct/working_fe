      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute bottom-0 left-1/3 w-[40rem] h-[40rem] rounded-full blur-3xl"
            style={{ backgroundColor: "#F5F5F5", opacity: 0.3 }}
          ></motion.div>
          ...
          <div className="grid gap-16 md:grid-cols-2 items-center py-16 text-center md:text-left">
            ...
            >
              <motion.div
                ...
                className="inline-block rounded-full px-4 py-1.5 text-sm font-medium backdrop-blur border-2"
                style={{ backgroundColor: 'hsl(40,100%,50%)', color: '#8B0000', borderColor: 'hsl(40,100%,50%)' }}
              >
              ...
              >
                ...
                <span className="block mt-2" style={{ color: 'hsl(0, 85%, 30%)' }}>Win More</span>
                <span className="block" style={{ color: "hsl(40, 100%, 50%)" }}>
                  Projects.
                </span>
              </motion.h1>
              <motion.p
                ...
                className="max-w-[600px] text-xl mx-auto md:mx-0"
                style={{ color: '#23272E' }}
              >
              ...
              >
                <div className="flex-1 max-w-md">
                  <Input
                    ...
                    className="h-12 bg-[#F5F5F5] border-[#FF784E] text-[#8B0000] placeholder:text-[#8B0000]/60 focus:border-[#FF784E]"
                  />
                </div>
                <Button
                  size="lg"
                  className="rounded-full bg-[#8B0000] hover:bg-[#8B0000] text-lg px-8 h-12 text-white transition-colors duration-200"
                >
            ...
            <div className="relative">
              ...
              >
                {/* Main image */}
                <motion.div
                  className="absolute top-0 left-0 w-3/4 h-3/5 rounded-lg overflow-hidden border-4 shadow-xl z-30 transform rotate-2"
                  style={{ borderColor: 'hsl(0, 85%, 30%)' }}
                ...
                {/* Secondary images */}
                <motion.div
                  className="absolute top-1/4 right-0 w-2/5 h-2/5 rounded-lg overflow-hidden border-4 shadow-xl z-20 transform -rotate-3"
                  style={{ borderColor: 'hsl(40, 100%, 50%)' }}
                  variants={itemVariants}
                ...
                <motion.div
                  className="absolute bottom-0 right-1/4 w-2/5 h-2/5 rounded-lg overflow-hidden border-4 shadow-xl z-20 transform rotate-6"
                  style={{ borderColor: 'hsl(0, 85%, 30%)' }}
                  variants={itemVariants}
                  whileHover={{ scale: 1.05, transition: { duration: 0.3 } }}
                  animate={
                ...
                {/* Fourth image */}
                <motion.div
                  className="absolute bottom-10 left-10 w-2/5 h-1/3 rounded-lg overflow-hidden border-4 shadow-xl z-10 transform -rotate-6"
                  style={{ borderColor: 'hsl(40, 100%, 50%)' }}
                  variants={itemVariants}
                  whileHover={{ scale: 1.05, transition: { duration: 0.3 } }}
                  animate={
                ...
                {/* Fifth image */}
                <motion.div
                  className="absolute top-1/3 right-1/4 w-1/3 h-1/4 rounded-lg overflow-hidden border-4 shadow-xl z-0 transform rotate-12"
                  style={{ borderColor: 'hsl(0, 85%, 30%)' }}
                  variants={itemVariants}
                  whileHover={{ scale: 1.05, transition: { duration: 0.3 } }}
                  animate={
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-40">
                  ...
                  >
                    ...
                    <motion.div
                      className="relative bg-[hsl(40,100%,50%)] backdrop-blur-sm rounded-full p-5 group-hover:bg-[hsl(0,85%,30%)] transition-all duration-300 shadow-lg"
                      whileHover={{
                        boxShadow: "0 0 15px 5px rgba(255, 120, 78, 0.3)",
                      }}
                    >
                      <Play
                        className="h-10 w-10"
                    ...
                    <motion.span
                      className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 whitespace-nowrap bg-[#F5F5F5] backdrop-blur-sm px-4 py-2 rounded-full font-bold shadow-lg"
        ...
        <motion.div 
                className="relative z-10 border-t border-[#F5F5F5] bg-[#F5F5F5] backdrop-blur-md mt-6"
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                <div className="container py-6 mx-auto">
                  <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                    {(
                      ...
                      >
                        <p className="text-2xl font-bold" style={{ color: '#8B0000' }}>{stat.value}</p>
                        <p className="text-sm" style={{ color: '#23272E' }}>{stat.label}</p>
                      </motion.div>
                    ))}
                  </div>
                </div>
