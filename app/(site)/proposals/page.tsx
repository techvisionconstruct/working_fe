          ...
          <div className="container mx-auto pt-8 pb-3">
            <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-4 mb-8">
              <div className="flex flex-col gap-1">
                <h1 className="text-4xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">Proposals</h1>
                <p className="text-base text-zinc-500 dark:text-zinc-400">Manage and track client proposals.</p>
              </div>
              <Link href={'/proposals/create'} className="shrink-0">
