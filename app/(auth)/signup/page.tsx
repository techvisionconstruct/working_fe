...
import { RegisterForm } from "@/components/features/auth/signup/signup-form";
  ...
  return (
    <div className="flex flex-col h-svh items-center justify-center bg-white">
      ...
      >
        ...
        <motion.div
          key="left-content"
          className="flex-1 w-full max-w-md mx-auto md:mx-0 order-1 md:order-1"
        ...
        >
          ...
          >
            <RegisterForm
              className="w-full"
              onSwitchToLogin={navigateToSignin}
            />
        ...
        <motion.div
          key="right-content"
          className="flex-1 max-w-xl w-full mx-auto md:mx-0 text-center md:text-left order-2 md:order-2"
        ...
        >
          <div className="flex flex-col items-center md:items-start">
            ...
            >
              Create an account to start building professional project proposals efficiently.
            </motion.h2>
